...
namespace Battlehub.HorizonBending
{
    ...
    public class HB : MonoBehaviour
    {
        ...
        [HideInInspector]
        [SerializeField]
        private Material m_defaultParticle = null;

        [SerializeField]
        private Material HBDefaultMaterial = null;
        [SerializeField]
        private Material HBDefaultParticle = null;
        [SerializeField]
        private Material HBDefaultUI = null;
        [SerializeField]
        private Material HBDefaultLeaves = null;
        [SerializeField]
        private Material HBDefaultBark = null;
        [SerializeField]
        private Material DefaultTreeCreatorLeaves = null;
        [SerializeField]
        private Material DefaultTreeCreatorBark = null;
